...
public class ReopenProjectHandler
{
    ...
    public ReopenProjectHandler(ApplicationDbContext dbContext)
    {
        _dbContext = dbContext;
    }

    public async Task<ProjectItemDto?> Handle(ReopenProjectCommand command, CancellationToken cancellationToken = default)
    {
